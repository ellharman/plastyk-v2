    ...
    <div className="w-full">
      <div className="relative w-full overflow-hidden rounded-sm" style={{ aspectRatio: "16 / 9", minHeight: 450 }}>
        <iframe
          ...
          src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/soundcloud%253Aplaylists%253A2298107244&color=%23ff7bac&auto_play=false&hide_related=true&show_artwork=true&show_comments=true&show_user=true&show_reposts=false&show_teaser=false&visual=false"
        />
      </div>
    </div>
  );
